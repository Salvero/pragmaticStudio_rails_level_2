...
describe "A movie" do
	it "is a flop if the total gross is less than $50M" do 
		...
		it "is a flop if the total gross exceeds $50M" do 
	...
	it "rejects improperly formatted image file names" do
		file_names = %w[movie .jpg .jpeg .png .gif movie.pdf movie.doc]
		file_names.each do |file_name|
			movie = Movie.new(image_file_name: file_name)
			movie.valid?
	...
	context "recent query" do
		before do
			...
			@movie4 = Movie.create!(movie_attributes(released_on: 1.hour.ago))
			@movie4 = Movie.create!(movie_attributes(released_on: 1.day.from_now))
		end
